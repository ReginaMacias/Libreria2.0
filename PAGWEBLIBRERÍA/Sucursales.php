...
<br>
  <p class="texto">
  ¡Visítanos! <br>
  Encuentra tu sucursal más cercana y ven a disfrutar de los maravillosos eventos con una deliciosa taza de nuestro café.
  <br>
  <br>
</p>
  ...
  <div class="map-cities">
    <div style="--x: 5; --y: 67;" class="map-city">
      <div class="map-city__label">
        <span data-icon="🏖️" class="map-city__sign">Mty, Centro 66358</span>
      </div>
    </div>
